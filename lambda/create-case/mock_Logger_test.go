...
func (_m *mockLogger) DebugContext(ctx context.Context, msg string, args ...any) {
	var _ca []interface{}
...
func (_c *mockLogger_DebugContext_Call) RunAndReturn(run func(context.Context, string, ...any)) *mockLogger_DebugContext_Call {
	_c.Call.Return(run)
	return _c
}
